    ...
    while True:
        ...
        if opcion == "1":
            try:
                ...
                print("Porfavor ingrese correctamente el titulo del libro.")
                print(e)
            except ErrorLibroSinAutor as e:
                print("Porfavor ingrese correctamente el autor del libro.")
                print(e)
            ...
            try:
                ...
                print(
                    f"Libro encontrado: {libro_encontrado.titulo} (Autor: {libro_encontrado.autor}, Año: {libro_encontrado.año_publicacion})")
            except ValueError as e:
                print(e)
